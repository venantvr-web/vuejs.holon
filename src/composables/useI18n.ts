...
const messages: Messages = {
  fr: {
    ...
    'toolbar.layouting': 'Mise en page…',
    'toolbar.algorithms': 'Algorithmes',
    // Menu Layout (algorithmes de mise en page automatique)
    'layout.force': 'Force',
    'layout.force.hint': 'Réseau de dépendances (d3-force)',
    'layout.hierarchical': 'Hiérarchique',
    'layout.hierarchical.hint': 'Arbre orienté (haut-bas)',
    'layout.tree': 'Arbre',
    'layout.tree.hint': 'Reingold-Tilford',
    'layout.circular': 'Circulaire',
    'layout.circular.hint': 'Placement radial',
    'layout.grid': 'Grille',
    'layout.grid.hint': 'Matrice 2D',
    // Menu Aligner / Distribuer / Harmoniser
    'align.title': 'Aligner',
    'align.left': 'Gauche',
    ...
    'align.bottom': 'Bas',
    'align.distribute': 'Distribuer',
    'align.horizontal': 'Horizontalement',
    'align.vertical': 'Verticalement',
    'align.matchSize': 'Harmoniser la taille',
    'align.width': 'Largeur',
    'align.height': 'Hauteur',
    'align.widthHeight': 'Largeur et hauteur',
  ...
  en: {
    ...
    'toolbar.layouting': 'Laying out…',
    'toolbar.algorithms': 'Algorithms',
    // Layout menu (automatic layout algorithms)
    'layout.force': 'Force',
    'layout.force.hint': 'Dependency network (d3-force)',
    'layout.hierarchical': 'Hierarchical',
    'layout.hierarchical.hint': 'Directed tree (top-bottom)',
    'layout.tree': 'Tree',
    'layout.tree.hint': 'Reingold-Tilford',
    'layout.circular': 'Circular',
    'layout.circular.hint': 'Radial placement',
    'layout.grid': 'Grid',
    'layout.grid.hint': '2D matrix',
    // Align / Distribute / Match menu
    'align.title': 'Align',
    'align.left': 'Left',
    ...
    'align.horizontal': 'Horizontally',
    'align.vertical': 'Vertically',
    'align.matchSize': 'Match size',
    'align.width': 'Width',
    'align.height': 'Height',
    'align.widthHeight': 'Width and height',
